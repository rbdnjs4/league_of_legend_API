...
function getSummonerInfo(method, data){
    ...
    switch(method){
        case "name":
            AfterURL += "by-name/"+data+"?api_key="+key;
            break;
        case "puuid":
            AfterURL += "by-puuid/"+data+"?api_key="+key;
            break;
        default:
            return;
    }
...
function getSummonerMasteryInfoBySummonerID(id){
    $.ajax({
        url: "https://kr.api.riotgames.com/lol/champion-mastery/v4/champion-masteries/by-summoner/"+id+"?api_key="+key,
        type: "GET",
        dataType: "json",
        data: {
            "api_key": key,
...
function getSummonerRecentGameHistoryBySummonerMatchID(userInfo, res) {
	$.ajax({
		url:"https://asia.api.riotgames.com/lol/match/v5/matches/"+res[0],
		type: "GET",
		dataType: "json",
		data: {
            "api_key": key,
		...
		success: function(data){
            console.log("Success to get Summoner's Match Data List");
			console.log(data.metadata.dataVersion);
        },
        error: function(req, stat, err){
            console.log(err);
        },
...
function getCurrentMatchBySummonerID(id){
    $.ajax({
        url: "https://kr.api.riotgames.com/lol/spectator/v4/active-games/by-summoner/"+id+"?api_key="+key,
        type: "GET",
        dataType: "json",
        data: {
            "api_key": key,
...
function loadSummonerMatchHistory(userInfo, info){
    ...
    for(let i=0;i<matchList.length;i++){
        ...
        let request = $.ajax({
            url: "https://kr.api.riotgames.com/lol/match/v4/matches/"+matchItemInfo.gameId+"?api_key="+key,
            type: "GET",
            dataType: "json",
            data: {
                "api_key": key,
...
function getAndLoadParticipantsLeagueInfoBySummonerID(span, id){
    $.ajax({
        ...
        success: function(res){
            ...
            $.ajax({
                url: "https://kr.api.riotgames.com/lol/summoner/v4/summoners/"+id+"?api_key="+key,
                type: "GET",
                aync: false,
                dataType: "json",
                data: {
